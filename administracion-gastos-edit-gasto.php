<div id="ModalEditExpense" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-md">
        <form action="javascript:void(0);">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel">Editar Gasto</h5>
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <select class="form-select " id="inputGroupSelect02">
                                <option selected>Otras Compras</option>
                        ...
                        <div class="col-12">
                            <div class="mb-2">
                                ...
                                <textarea class="form-control" id="detalle" rows="2">Cafe</textarea>
                            </div>
                        </div>
                        <div class="col-12">
                            <label for="firstNameinput" class="form-label">Caja</label>
                            <select class="form-select " id="inputGroupSelect02">
                                <option selected>caja: 1268, administrativo Maldonado</option>
                            </select>                        
                        </div><!--end col-->
