                        ...
                        <div class="app-search flex-wrap d-none d-md-block">
                            ...
                            width: 500px;">
                                <div class="p-4">
                                    <div class="row g-3">
                                        <div class="col-6">
                                            <h6 class="title-item">Administración</h6>
                                            <ul class="list-unstyled mb-0" aria-labelledby="dropdownMenuOffset">
                                                <li><a class="dropdown-item" href="../administracion-gastos.php">Gastos</a></li>
                                                <li><a class="dropdown-item" href="../administracion-inventario.php">Inventario</a></li>
                                                <li><a class="dropdown-item" href="../administracion-laboratorio.php">Laboratorio</a></li>
                                                <li><a class="dropdown-item" href="../administracion-planes-y-servicios.php">Planes y Servicio</a></li>
                                            </ul>
                                        </div>
                                        <div class="col-6">
                                            <ul class="list-unstyled mb-0" aria-labelledby="dropdownMenuOffset">
                                                <h6 class="title-item">Configuración</h6>
                                                <li><a class="dropdown-item" href="../configuracion-aranceles-de-precios.php">Arancel de precios</a></li>
                                                <li><a class="dropdown-item" href="../configuracion-documentos-clinicos.php">Documentos Clínicos</a></li>
                                                <li><a class="dropdown-item" href="../configuracion-consentimientos-informados.php">Consentimientos informados</a></li>
                                                <li><a class="dropdown-item" href="../configuracion-logotipo.php">Logotipo</a></li>
                                                <li><a class="dropdown-item" href="../configuracion-pagos-anulados-y-pendientes.php">Pagos anulados y pendientes</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown d-md-none topbar-head-dropdown header-item">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" aria-labelledby="page-header-search-dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end" aria-labelledby="configuraciones">
                                    ...
                                    <a class="dropdown-item" href="../administracion-gastos.php">Gastos</a>
                                    <a class="dropdown-item" href="../administracion-inventario.php">Inventario</a>
                                    <a class="dropdown-item" href="../administracion-laboratorio.php">Laboratorio</a>
                                    <a class="dropdown-item" href="../administracion-planes-y-servicios.php">Planes y Servicio</a>
                                    <div class="dropdown-divider"></div>
                                    <div class="dropdown-header"><h6>Configuración</h6></div>
                                    <a class="dropdown-item" href="../configuracion-aranceles-de-precios.php">Arancel de precios</a>
                                    <a class="dropdown-item" href="../configuracion-documentos-clinicos.php">Documentos Clínicos</a>
                                    <a class="dropdown-item" href="../configuracion-consentimientos-informados.php">Consentimientos informados</a>
                                    <a class="dropdown-item" href="../configuracion-logotipo.php">Logotipo</a>
                                    <a class="dropdown-item" href="../configuracion-pagos-anulados-y-pendientes.php">Pagos anulados y pendientes</a>
                                </div>
                            </div>
                        ...
                        <div class="dropdown ms-sm-3 header-item topbar-user">
                            <button type="button" class="btn material-shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="d-flex align-items-center">
                                    ...
                                    <span class="text-start ms-xl-2">
                                        <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">Ana Adame</span>
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <!-- item-->
                                <h6 class="dropdown-header">Welcome Ana Adame!</h6>
                                <a class="dropdown-item" href="javascript:void(0);"><i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Perfil</span></a>
